...
const DEMO_ENTRIES: AIBOMEntry[] = [
  { file_path:"src/processors/card_validator.py",            language:"python",     ai_percentage:0.95, risk_score:"CRITICAL", risk_indicators:["sql-injection","hardcoded-secret","eval-exec"], scan_id:"sc_001", repo:"acme/payments-api",         scanned_at:"2026-06-02T10:00:00Z", attested:false },
  { file_path:"src/gateway/stripe_client.py",                 language:"python",     ai_percentage:0.79, risk_score:"HIGH",     risk_indicators:["hardcoded-secret"],                              scan_id:"sc_001", repo:"acme/payments-api",         scanned_at:"2026-06-02T10:00:00Z", attested:false },
  { file_path:"src/middleware/auth_check.ts",                 language:"typescript", ai_percentage:0.66, risk_score:"HIGH",     risk_indicators:["structural-uniformity"],                         scan_id:"sc_001", repo:"acme/payments-api",         scanned_at:"2026-06-02T10:00:00Z", attested:false },
  { file_path:"src/services/payment_service.ts",              language:"typescript", ai_percentage:0.84, risk_score:"HIGH",     risk_indicators:["hardcoded-secret"],                              scan_id:"sc_001", repo:"acme/payments-api",         scanned_at:"2026-06-02T10:00:00Z", attested:false },
  { file_path:"src/auth/token_service.py",                    language:"python",     ai_percentage:0.77, risk_score:"HIGH",     risk_indicators:["hardcoded-secret"],                              scan_id:"sc_002", repo:"acme/auth-service",         scanned_at:"2026-06-01T10:00:00Z", attested:false },
  { file_path:"models/risk_scorer.ts",                        language:"typescript", ai_percentage:0.89, risk_score:"CRITICAL", risk_indicators:["eval-exec"],                                      scan_id:"sc_003", repo:"acme/fraud-detection",      scanned_at:"2026-05-31T10:00:00Z", attested:false },
  { file_path:"src/database/connection.py",                   language:"python",     ai_percentage:0.73, risk_score:"HIGH",     risk_indicators:["hardcoded-secret","sql-injection"],              scan_id:"sc_003", repo:"acme/fraud-detection",      scanned_at:"2026-05-31T10:00:00Z", attested:false },
  { file_path:"src/models/anomaly_detector.py",               language:"python",     ai_percentage:0.68, risk_score:"MEDIUM",   risk_indicators:["structural-uniformity"],                         scan_id:"sc_003", repo:"acme/fraud-detection",      scanned_at:"2026-05-31T10:00:00Z", attested:false },
  { file_path:"src/connectors/bigquery_writer.ts",            language:"typescript", ai_percentage:0.85, risk_score:"HIGH",     risk_indicators:["hardcoded-secret","sql-injection"],              scan_id:"sc_005", repo:"acme/data-platform",        scanned_at:"2026-05-29T10:00:00Z", attested:false },
  { file_path:"src/pipelines/etl_runner.py",                  language:"python",     ai_percentage:0.67, risk_score:"HIGH",     risk_indicators:["sql-injection"],                                 scan_id:"sc_005", repo:"acme/data-platform",        scanned_at:"2026-05-29T10:00:00Z", attested:false },
  { file_path:"src/models/inference_engine.py",               language:"python",     ai_percentage:0.93, risk_score:"CRITICAL", risk_indicators:["eval-exec","hardcoded-secret","sql-injection"],  scan_id:"sc_006", repo:"acme/ml-platform",          scanned_at:"2026-05-28T10:00:00Z", attested:false },
  { file_path:"src/training/data_pipeline.py",                language:"python",     ai_percentage:0.87, risk_score:"HIGH",     risk_indicators:["hardcoded-secret","sql-injection"],              scan_id:"sc_006", repo:"acme/ml-platform",          scanned_at:"2026-05-28T10:00:00Z", attested:false },
  { file_path:"src/serving/model_server.py",                  language:"python",     ai_percentage:0.81, risk_score:"HIGH",     risk_indicators:["eval-exec"],                                     scan_id:"sc_006", repo:"acme/ml-platform",          scanned_at:"2026-05-28T10:00:00Z", attested:false },
  { file_path:"src/providers/email_sender.py",                language:"python",     ai_percentage:0.78, risk_score:"HIGH",     risk_indicators:["hardcoded-secret"],                              scan_id:"sc_009", repo:"acme/notification-service", scanned_at:"2026-05-25T10:00:00Z", attested:false },
  { file_path:"src/templates/render_engine.ts",               language:"typescript", ai_percentage:0.64, risk_score:"MEDIUM",   risk_indicators:["structural-uniformity"],                         scan_id:"sc_009", repo:"acme/notification-service", scanned_at:"2026-05-25T10:00:00Z", attested:false },
  { file_path:"pkg/orders/handler.go",                        language:"go",         ai_percentage:0.87, risk_score:"CRITICAL", risk_indicators:["sql-injection","hardcoded-secret"],              scan_id:"sc_010", repo:"acme/order-service",        scanned_at:"2026-05-24T10:00:00Z", attested:false },
  { file_path:"internal/db/queries.go",                       language:"go",         ai_percentage:0.71, risk_score:"HIGH",     risk_indicators:["sql-injection"],                                 scan_id:"sc_010", repo:"acme/order-service",        scanned_at:"2026-05-24T10:00:00Z", attested:false },
  { file_path:"src/main/java/billing/PaymentProcessor.java",  language:"java",       ai_percentage:0.82, risk_score:"HIGH",     risk_indicators:["hardcoded-secret"],                              scan_id:"sc_011", repo:"acme/billing-service",      scanned_at:"2026-05-23T10:00:00Z", attested:false },
  { file_path:"src/main/java/billing/InvoiceService.java",    language:"java",       ai_percentage:0.64, risk_score:"MEDIUM",   risk_indicators:["structural-uniformity"],                         scan_id:"sc_011", repo:"acme/billing-service",      scanned_at:"2026-05-23T10:00:00Z", attested:false },
  { file_path:"src/crypto/hash.rs",                           language:"rust",       ai_percentage:0.76, risk_score:"HIGH",     risk_indicators:["hardcoded-secret"],                              scan_id:"sc_012", repo:"acme/cli-tools",            scanned_at:"2026-05-22T10:00:00Z", attested:false },
  { file_path:"src/net/http_client.rs",                       language:"rust",       ai_percentage:0.69, risk_score:"MEDIUM",   risk_indicators:["structural-uniformity"],                         scan_id:"sc_012", repo:"acme/cli-tools",            scanned_at:"2026-05-22T10:00:00Z", attested:false },
  { file_path:"src/middleware/auth_interceptor.ts",           language:"typescript", ai_percentage:0.81, risk_score:"HIGH",     risk_indicators:["structural-uniformity"],                         scan_id:"sc_007", repo:"acme/api-gateway",          scanned_at:"2026-05-27T10:00:00Z", attested:true  },
  { file_path:"src/scoring/ml_pipeline.ts",                   language:"typescript", ai_percentage:0.74, risk_score:"MEDIUM",   risk_indicators:["comment-density"],                               scan_id:"sc_004", repo:"acme/risk-engine",          scanned_at:"2026-05-30T10:00:00Z", attested:true  },
  { file_path:"src/handlers/profile_update.ts",               language:"typescript", ai_percentage:0.61, risk_score:"MEDIUM",   risk_indicators:["comment-density"],                               scan_id:"sc_008", repo:"acme/user-service",         scanned_at:"2026-05-26T10:00:00Z", attested:true  },
];
