...
const SIGNAL_META: Record<string, { label: string; desc: string; sev: SignalSev; security?: boolean }> = {
  ...
  "bola-missing-ownership-check": { label: "Broken Object Level Authorization (AST-verified)", desc: "A Spring resource-identifier parameter reaches a repository/map lookup with no @PreAuthorize/@Secured/@RolesAllowed and no identity comparison anywhere in the method — real per-parameter AST evidence, not a keyword-proximity guess", sev: "high", security: true },
