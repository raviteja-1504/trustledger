...
export function makeDefaultFrameworks(
  org: string,
  ...
  return [
    {
      ...
      controls: [
        { id:"CC6.1", label:"Logical Access Controls", description:"AI-authored changes reviewed only by authorised personnel via role-based access and attestation workflow.", weight:25, owner:"Security Lead", last_tested:"2026-05-01", next_test:"2026-08-01", test_frequency:"quarterly",
        ...
        { id:"CC6.2", label:"Authentication", description:"Reviewer identity verified via GitHub OAuth — no anonymous attestations permitted.", weight:20, owner:"Security Lead", last_tested:"2026-04-15", next_test:"2026-07-15", test_frequency:"quarterly",
        ...
        { id:"A1.2", label:"Availability", description:"Audit trail retained and accessible for ≥ 12 months. All scan and attestation records preserved.", weight:10, owner:"Compliance Officer", last_tested:"2026-05-01", next_test:"2026-11-01", test_frequency:"annually",
    ...
    },
    {
      ...
      controls: [
        { id:"Art.9",  label:"Risk Management System", description:"Continuous identification, analysis and mitigation of AI system risks — documented and reviewable.", weight:25, owner:"Security Lead", last_tested:"2026-05-10", next_test:"2026-08-10", test_frequency:"quarterly",
        ...
        { id:"Art.10", label:"Data Governance", description:"Training data provenance documented per file — AI% and source metadata captured at scan time.", weight:20, owner:"DevOps Lead", last_tested:"2026-05-01", next_test:"2026-08-01", test_frequency:"quarterly",
          evidence_items:[{ type:"audit-trail", description:"AI provenance records per file", auto:true }],
          cross_map:[] },
        { id:"Art.13", label:"Transparency", description:"AI-generated code percentage disclosed per PR — automatically added to status checks.", weight:20, owner:"DevOps Lead", last_tested:"2026-05-20", next_test:"2026-08-20", test_frequency:"quarterly",
          evidence_items:[{ type:"scan-log", description:"AI% disclosure per PR scan result", auto:true }],
          cross_map:[] },
        { id:"Art.14", label:"Human Oversight", description:"Named human reviewer required for CRITICAL AI files — policy gate enforces sign-off before merge.", weight:25, owner:"Security Lead", last_tested:"2026-05-15", next_test:"2026-08-15", test_frequency:"quarterly",
        ...
        { id:"Art.17", label:"Quality Management", description:"Post-deployment monitoring via continuous automated scanning — every PR on every monitored repo.", weight:10, owner:"Compliance Officer", last_tested:"2026-05-20", next_test:"2026-08-20", test_frequency:"quarterly",
    ...
    },
    {
      ...
      controls: [
        ...
        { id:"6.3.2", label:"Software Inventory", description:"AI-authored code logged per file and pull request — full AIBOM maintained.", weight:25, owner:"DevOps Lead", last_tested:"2026-05-01", next_test:"2026-08-01", test_frequency:"quarterly",
          ...
          cross_map:[] },
        { id:"6.4.1", label:"Security Vulnerabilities", description:"CRITICAL-risk AI files blocked automatically from merge — zero manual override.", weight:20, owner:"Security Lead", last_tested:"2026-05-15", next_test:"2026-08-15", test_frequency:"quarterly",
          evidence_items:[{ type:"scan-log", description:"Blocked merge evidence per blocked file", auto:true }],
          cross_map:[] },
        { id:"6.4.2", label:"Change Control Process", description:"Dual-reviewer attestation required for payment-system changes — SOD enforced via policy.", weight:25, owner:"Security Lead", last_tested:"2026-05-20", next_test:"2026-08-20", test_frequency:"quarterly",
        ...
        { id:"6.4.3", label:"Payment Page Security", description:"AI content in payment paths flagged for mandatory review — high-risk repos monitored continuously.", weight:0, owner:"Compliance Officer", last_tested:"2026-05-10", next_test:"2026-08-10", test_frequency:"quarterly",
    ...
    },
    {
      ...
      controls: [
        { id:"A.8.25", label:"Secure Development Lifecycle", description:"TrustLedger scans every pull request — continuous security testing embedded in the SDLC, not bolted on after delivery.", weight:25, owner:"Security Lead", last_tested:"2026-05-20", next_test:"2026-08-20", test_frequency:"quarterly",
        ...
        { id:"A.8.26", label:"Application Security Requirements", description:"Policy gates codify AI content thresholds and attestation mandates — security requirements enforced automatically at merge time.", weight:20, owner:"Security Lead", last_tested:"2026-05-15", next_test:"2026-08-15", test_frequency:"quarterly",
        ...
        { id:"A.8.28", label:"Secure Coding", description:"Every AI-generated file must be attested by a named reviewer before merge — mandatory secure coding verification for all AI output.", weight:25, owner:"Security Lead", last_tested:"2026-05-20", next_test:"2026-08-20", test_frequency:"quarterly",
        ...
        { id:"A.8.30", label:"Outsourced Development", description:"AI coding tools governed as outsourced development suppliers — AI origin tracked per file via AIBOM with full tool provenance.", weight:20, owner:"DevOps Lead", last_tested:"2026-05-01", next_test:"2026-08-01", test_frequency:"quarterly",
        ...
        { id:"A.5.33", label:"Protection of Records", description:"Immutable cryptographically-chained audit log satisfies records integrity requirements — tamper detection built in to every event.", weight:10, owner:"Compliance Officer", last_tested:"2026-05-01", next_test:"2026-11-01", test_frequency:"annually",
